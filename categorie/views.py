...
class CategorieView(Frame):
    ...
    # parametrer les colonnes
        ...
        tree.column("deux", width=150, minwidth=150)
        tree.column("trois", width=150, minwidth=150)
        tree.column("quatre", width=150, minwidth=150)
        tree.column("cinq", width=150, minwidth=150)
        tree.column("six", width=150, minwidth=150)
        tree.column("sept", width=150, minwidth=150)
        tree.column("huit", width=150, minwidth=150)
        tree.column("neuf", width=150, minwidth=150)
    ...
    # insertion des lignes du tableau
        ...
        frame.pack(pady=30, padx=30) # affichage du frame sur la fenetre
